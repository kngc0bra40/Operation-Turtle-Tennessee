...
const smartAfterSave=smartImportSource.slice(smartImportSource.indexOf('async function afterPropertySaved'),smartImportSource.indexOf('async function preparePropertyRefresh')),smartRefresh=smartImportSource.slice(smartImportSource.indexOf('async function preparePropertyRefresh'),smartImportSource.indexOf('function optionHtml'))+smartImportSource.slice(smartImportSource.indexOf('async function refreshPropertyDataComplete'),smartImportSource.indexOf('window.refreshPropertyData=refreshPropertyDataComplete')),profileSave=app.slice(app.indexOf('function savePropertyScorecardV3'),app.indexOf('savePropertyScorecard=savePropertyScorecardV3;')),profileDraft=app.slice(app.indexOf('function propertyProfileDraft'),app.indexOf('function intelligenceRecordWithProfile'));
